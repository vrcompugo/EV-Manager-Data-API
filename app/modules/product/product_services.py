...
def get_items(tree, sort, offset, limit, fields):
    return get_items_by_model(Product, ProductSchema, tree, sort, offset, limit, fields)


def get_one_item(id, fields = None):
    return get_one_item_by_model(Product, ProductSchema, id, fields, [db.subqueryload("role")])
