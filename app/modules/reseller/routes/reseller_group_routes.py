...
from ..services.reseller_group_services import add_item, update_item, get_items, get_one_item


api = Namespace('ResellerGroups')

_item_input = api.model("ResellerGroup_", model={
    ...
    'reseller_group_id': fields.Integer(description=''),
...
class Items(Resource):
    ...
    @token_required("list_reseller_group")
    def get(self):
        """
            List reseller_groups
            sort:
    ...
    @token_required("create_reseller_group")
    def post(self):
        """Creates a new User """
        data = request.json
...
class User(Resource):
    ...
    @token_required("show_reseller_group")
    def get(self, id):
        """get a reseller_group given its identifier"""
        fields = request.args.get("fields") or "_default_"
    ...
    @api.doc('update reseller_group')
    @api.expect(_item_input, validate=True)
    @token_required("update_reseller_group")
    def put(self, id):
        """Update User """
        data = request.json
    ...
    @api_response
    @token_required("delete_reseller_group")
    def delete(self, id):
